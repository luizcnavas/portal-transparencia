    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (footerSearchForm && footerSearchInput) {
            ...
            const searchMap = {
                ...
                'ata da diretoria': '{{ route("documentos.index") }}',
                'cnpj': '{{ route("documentos.index") }}',
                ...
                'estatuto social': '{{ route("legislacoes.index") }}',
                'certificado nacional': '{{ route("legislacoes.index") }}',
                'informações': '{{ route("informacoes.index") }}',
                'informacoes': '{{ route("informacoes.index") }}',
                'informacao': '{{ route("informacoes.index") }}',
                'informação': '{{ route("informacoes.index") }}',
